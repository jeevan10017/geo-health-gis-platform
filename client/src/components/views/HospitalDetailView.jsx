        ...
        <div className="mt-2 flex flex-col sm:flex-row sm:items-center sm:gap-4">
          <div className="relative w-full sm:w-3/5">
            ...
            <input
              ...
              className="w-full rounded-md border border-slate-300 pl-10 pr-4 py-2 text-sm sm:text-base focus:ring-2 focus:ring-indigo-500 focus:outline-none"
            />
          </div>
